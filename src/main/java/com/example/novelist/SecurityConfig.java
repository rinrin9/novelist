...
import com.example.novelist.filter.FormAuthenticationProvider;
...
import com.example.novelist.entity.SocialUser;
import com.example.novelist.entity.User;
import com.example.novelist.entity.User.Authority;
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/login", "/logout-complete", "/users/new", "/user").permitAll()
                ...
                // form
                .and().formLogin().loginPage("/login").defaultSuccessUrl("/top", true).failureUrl("/login-failure")
                // oauth2
